...
EnvName = ['BreakoutNoFrameskip-v4','EnduroNoFrameskip-v4', 'PongNoFrameskip-v4','AssaultNoFrameskip-v4',
           'ALE/Galaxian-v5','AirRaidNoFrameskip-v4','MsPacmanNoFrameskip-v4','TennisNoFrameskip-v4','ALE/Tetris-v5',
...
def main():
    ...
    env = make_env_tianshou(EnvName[opt.EnvIdex],seed = opt.seed,render = opt.render, noop_reset = opt.noop_reset, episode_life = True, clip_rewards = True)
    eval_env = make_env_tianshou(EnvName[opt.EnvIdex],seed = opt.seed+1,render = opt.render, noop_reset = opt.noop_reset, episode_life = True, clip_rewards = True)
