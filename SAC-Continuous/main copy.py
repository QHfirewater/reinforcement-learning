...
parser.add_argument('--ModelIdex', type=int, default=470, help='which model to load')
...
def main():
    ...
    # Build Env
    env = gym.make(EnvName[opt.EnvIdex], render_mode = "human" if opt.render else None,new_step_api=True)
