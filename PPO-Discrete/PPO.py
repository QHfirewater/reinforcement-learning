...
class PPO_discrete():
    ...
    def save(self, name,episode):
        torch.save(self.critic.state_dict(), "./model/{}ppo_critic{}.pth".format(name,episode))
        torch.save(self.actor.state_dict(), "./model/{}ppo_actor{}.pth".format(name,episode))

    def load(self, name,episode):
        self.critic.load_state_dict(torch.load("./model/{}ppo_critic{}.pth".format(name,episode)))
        self.actor.load_state_dict(torch.load("./model/{}ppo_actor{}.pth".format(name,episode)))
